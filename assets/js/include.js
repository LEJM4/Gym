/* ===========================================================
   include.js – ERIK-Fit Modular System v6.3
   Lädt Layout, Sections & Components automatisch
   + Theme, Language, Auth-Check, SPA-Kompatibilität
   =========================================================== */
...
// ===========================================================
// 🧭 PARTIALS LADEN (Topbar + Sidebar + Footer)
// ===========================================================
async function loadPartials() {
  try {
    const [topbarHtml, sidebarHtml, footerHtml] = await Promise.all([
      fetch("./partials/layout/topbar.html").then((r) =>
        r.ok ? r.text() : Promise.reject("Topbar Fehler")
      ),
      fetch("./partials/layout/sidebar.html").then((r) =>
        r.ok ? r.text() : Promise.reject("Sidebar Fehler")
      ),
      fetch("./partials/layout/footer.html").then((r) =>
        r.ok ? r.text() : Promise.reject("Footer Fehler")
      ),
    ]);
...
// ===========================================================
// 🧾 Vertragsauswahl (Mitgliedschaften) – mit Login-Check
// ===========================================================
...
// ===========================================================
// 🔁 FOOTER Handling: SPA-kompatibel + Mehrsprachig
// ===========================================================
...
// ===========================================================
// 🌍 Sprachmenü mit aktiver Markierung + updateLanguage()
// ===========================================================
document.addEventListener("click", async (e) => {
  ...
  if (toggle) {
    ...
    if (dropdown.classList.contains("show")) highlightActiveLang();
    return;
  }

  if (!e.target.closest(".lang-menu")) dropdown.classList.remove("show");
